...
var DEFAULT_CONFIG = {
    UNCHECKED_NORM: host + '/Images/Chk_tri_state/unchecked.gif',
    UNCHECKED_HILI: host + '/Images/Chk_tri_state/unchecked_highlighted.gif',
    INTERMEDIATE_NORM: host + '/Images/Chk_tri_state/intermediate.gif',
    INTERMEDIATE_HILI: host + '/Images/Chk_tri_state/intermediate_highlighted.gif',
    CHECKED_NORM: host + '/Images/Chk_tri_state/checked.gif',
    CHECKED_HILI: host + '/Images/Chk_tri_state/checked_highlighted.gif'
};
...
var defAllTheCheckboxes;
var defTriStateBoxField;
var defImageNodeId;
...
function initTriStateCheckBox(triStateBoxId, containerOrStateFieldId, standAloneMode) {
	...
	defAllTheCheckboxes = allTheCheckboxes;
	defTriStateBoxField = triStateBoxField;
    defImageNodeId = imageNodeId;
}

function DefaultUpdate() {
    updateStateAndImage(defAllTheCheckboxes, defTriStateBoxField, defImageNodeId);
}
